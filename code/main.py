...
class Game:
    def load_images(self):
        self.bullet_surf = pygame.image.load(
            join('images', 'gun', 'bullet.png')).convert_alpha()
    ...
    def input(self):
        if pygame.mouse.get_pressed()[0] and self.can_shoot:
            ...
            pos = self.gun.rect.center + self.gun.gun_direction * 50
            Bullet(self.bullet_surf, pos, self.gun.gun_direction,
        ...
        while self.running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == self.enemy_event:
                    Enemy(choice(self.enemy_spawn_positions), choice(list(self.enemy_frames.values())),
    ...
    def setup(self):
        ...
        for obj in map.get_layer_by_name('Collisions'):
            CollisionSprite((obj.x, obj.y), pygame.Surface(
